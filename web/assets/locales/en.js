...
window.I18N_LOCALES['en'] = {
  ...
  'modelTest.verifyModel': 'Verify model',
  'modelTest.verifyModelTitle': 'Checks response model metadata, the model catalog, and web bridge signals. It makes one extra model-catalog request and cannot prove the underlying model.',
  'modelTest.verification.mismatch': 'Model name mismatch',
  'modelTest.verification.consistent': 'Model name consistent (unproven)',
  'modelTest.verification.unverified': 'Unverified',
  'modelTest.verification.webBridge': 'Likely web bridge',
  'modelTest.verification.claimed': 'Requested model: {model}',
  'modelTest.verification.effective': 'Effective upstream model: {model}',
  'modelTest.verification.reported': 'Response-reported model: {model}',
  'modelTest.verification.rewritten': 'The channel configuration rewrote the model name',
  'modelTest.verification.catalogAvailable': 'Model catalog: {count} entries',
  'modelTest.verification.effectiveListed': 'Effective upstream model is listed',
  'modelTest.verification.effectiveNotListed': 'Effective upstream model is not listed',
  'modelTest.verification.reportedListed': 'Response-reported model is listed',
  'modelTest.verification.reportedNotListed': 'Response-reported model is not listed',
  'modelTest.verification.catalogUnavailable': 'Model catalog unavailable',
  'modelTest.verification.webBridgeDetail': 'Detected a ChatGPT Web backend endpoint signal',
  'modelTest.verification.limitation': 'Response metadata and model catalogs can be forged by an intermediary; this cannot prove the underlying model.',
