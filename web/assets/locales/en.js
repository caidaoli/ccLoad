...
window.I18N_LOCALES['en'] = {
  ...
  'groups.title': 'Model Management - Claude Code & Codex Proxy',
  'groups.description': 'Attach real models from multiple channels to one model name, and isolate cooldown at the channel + model level.',
  'groups.add': '+ Add Model',
  'groups.empty': 'No models yet',
  'groups.noItems': 'No members yet',
  'groups.members': '{count} members',
  'groups.channel': 'Channel',
  'groups.model': 'Actual Model',
  'groups.priority': 'Priority',
  'groups.weight': 'Weight',
  'groups.field.name': 'Model Name',
  'groups.field.routeMode': 'Route Mode',
  'groups.field.matchRegex': 'Match Regex',
  'groups.field.firstTokenTimeout': 'First Token Timeout (s)',
  'groups.field.sessionKeepTime': 'Session Keep Time (s)',
  'groups.field.availableModels': 'Available Models',
  'groups.field.searchModels': 'Search Models',
  'groups.field.searchModelsHint': 'Pick models on the left, search them, or auto-add in one click.',
  'groups.field.items': 'Model Members',
  'groups.field.itemSelector': 'Channel / Model',
  'groups.mode.roundRobin': 'Round Robin',
  'groups.mode.random': 'Random',
  'groups.mode.failover': 'Failover',
  'groups.mode.weighted': 'Weighted',
  'groups.modal.createTitle': 'Add Model',
  'groups.modal.editTitle': 'Edit Model',
  'groups.actions.addItem': 'Add Member',
  'groups.actions.autoAdd': 'Auto Add',
  'groups.actions.moveUp': 'Move Up',
  'groups.actions.moveDown': 'Move Down',
  'groups.actions.removeItem': 'Remove Member',
  'groups.hint.matchRegex': 'When set, models are auto-matched by regex. Otherwise the model name is used for fuzzy matching.',
  'groups.hint.firstTokenTimeout': 'If one channel under this model takes too long to start responding, switch to the next one after this many seconds.',
  'groups.hint.sessionKeepTime': 'Try to keep the same token on the last successful channel for this many seconds.',
  'groups.hint.priorityAuto': 'The order on the right becomes the priority. Item #1 is tried first.',
  'groups.hint.weightedMode': 'In weighted mode, higher weight means the member is more likely to be chosen.',
  'groups.confirmDelete': 'Delete model "{name}"?',
  'groups.validation.nameRequired': 'Model name is required',
  'groups.validation.itemRequired': 'Please complete every model member row',
  'groups.messages.created': 'Model created',
  'groups.messages.updated': 'Model updated',
  'groups.messages.deleted': 'Model deleted',
  'groups.messages.loadFailed': 'Failed to load models',
  'groups.messages.saveFailed': 'Failed to save model',
  'groups.messages.deleteFailed': 'Failed to delete model',
  'groups.messages.invalidRegex': 'Invalid regex: {error}',
  'groups.messages.noAutoAddMatch': 'No new models matched for auto-add',
  'groups.messages.noSearchMatch': 'No models matched your search',
  'groups.messages.noSelectedModels': 'No members yet. Pick models from the left first.',
  'groups.messages.noModelOptions': 'No channel/model options are available right now',
  'groups.meta.matchByName': 'Fuzzy match by model name',
