...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'groups.title': '模型管理 - Claude Code & Codex Proxy',
  'groups.description': '把多个渠道里的真实模型挂到同一个模型名下，并把失败冷却隔离到渠道 + 模型级别。',
  'groups.add': '+ 添加模型',
  'groups.empty': '还没有模型',
  'groups.noItems': '暂无成员',
  'groups.members': '{count} 个成员',
  'groups.channel': '渠道',
  'groups.model': '真实模型',
  'groups.priority': '优先级',
  'groups.weight': '权重',
  'groups.field.name': '模型名',
  'groups.field.routeMode': '路由模式',
  'groups.field.matchRegex': '匹配正则',
  'groups.field.firstTokenTimeout': '首包超时（秒）',
  'groups.field.sessionKeepTime': '会话保持（秒）',
  'groups.field.availableModels': '可选模型',
  'groups.field.searchModels': '搜索模型',
  'groups.field.searchModelsHint': '左边挑模型，支持搜索和一键自动加成员。',
  'groups.field.items': '模型成员',
  'groups.field.itemSelector': '渠道 / 模型',
  'groups.mode.roundRobin': '轮询',
  'groups.mode.random': '随机',
  'groups.mode.failover': '故障转移',
  'groups.mode.weighted': '加权',
  'groups.modal.createTitle': '添加模型',
  'groups.modal.editTitle': '编辑模型',
  'groups.actions.addItem': '添加成员',
  'groups.actions.autoAdd': '自动添加',
  'groups.actions.moveUp': '上移',
  'groups.actions.moveDown': '下移',
  'groups.actions.removeItem': '删除成员',
  'groups.hint.matchRegex': '填了正则就按正则自动匹配，不填就按模型名模糊匹配。',
  'groups.hint.firstTokenTimeout': '这个模型里的某条渠道太久没开始返回内容，就按你这里的秒数切下一个。',
  'groups.hint.sessionKeepTime': '同一个令牌短时间内尽量继续命中上次成功的渠道。',
  'groups.hint.priorityAuto': '右边顺序就是优先级，第 1 个最先尝试。',
  'groups.hint.weightedMode': '加权模式下，权重越大越容易被选中。',
  'groups.confirmDelete': '确定删除模型 “{name}” 吗？',
  'groups.validation.nameRequired': '模型名不能为空',
  'groups.validation.itemRequired': '请先补全模型成员',
  'groups.messages.created': '模型已创建',
  'groups.messages.updated': '模型已更新',
  'groups.messages.deleted': '模型已删除',
  'groups.messages.loadFailed': '加载模型失败',
  'groups.messages.saveFailed': '保存模型失败',
  'groups.messages.deleteFailed': '删除模型失败',
  'groups.messages.invalidRegex': '正则无效：{error}',
  'groups.messages.noAutoAddMatch': '没有找到可自动加入的新模型',
  'groups.messages.noSearchMatch': '没有匹配到模型',
  'groups.messages.noSelectedModels': '右边还没有成员，先从左边点几个模型进来。',
  'groups.messages.noModelOptions': '当前没有可选的渠道模型',
  'groups.meta.matchByName': '按模型名模糊匹配',
