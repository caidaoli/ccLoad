...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'modelTest.stream': '流式',
  'modelTest.verifyModel': '模型核验',
  'modelTest.verifyModelTitle': '核对上游响应模型名、模型目录和网页桥接特征；会额外请求一次模型目录，不能证明底层模型。',
  'modelTest.verification.mismatch': '模型名不一致',
  'modelTest.verification.consistent': '模型名一致（未证实）',
  'modelTest.verification.unverified': '未验证',
  'modelTest.verification.webBridge': '疑似网页桥接',
  'modelTest.verification.claimed': '请求模型：{model}',
  'modelTest.verification.effective': '实际上游模型：{model}',
  'modelTest.verification.reported': '响应声明模型：{model}',
  'modelTest.verification.rewritten': '渠道配置改写了模型名',
  'modelTest.verification.catalogAvailable': '模型目录：{count} 项',
  'modelTest.verification.effectiveListed': '实际上游模型在目录中',
  'modelTest.verification.effectiveNotListed': '实际上游模型不在目录中',
  'modelTest.verification.reportedListed': '响应声明模型在目录中',
  'modelTest.verification.reportedNotListed': '响应声明模型不在目录中',
  'modelTest.verification.catalogUnavailable': '模型目录不可用',
  'modelTest.verification.webBridgeDetail': '检测到 ChatGPT Web 后端接口特征',
  'modelTest.verification.limitation': '响应元数据和模型目录可被中转伪造，不能证明底层模型。',
