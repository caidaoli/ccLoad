...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'channels.batchRefreshRowProcessing': '模型刷新中...',
  'channels.batchRefreshRowUpdatedMerge': '已更新：获取 {fetched}，新增 {added}，总计 {total}',
  'channels.batchRefreshRowUpdatedReplace': '已更新：获取 {fetched}，移除 {removed}，总计 {total}',
  'channels.batchRefreshRowUnchanged': '未变化：获取 {fetched}，总计 {total}',
  'channels.batchRefreshRowFailed': '失败：{error}',
