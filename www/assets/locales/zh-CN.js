...
window.I18N_LOCALES['zh-CN'] = Object.assign(window.I18N_LOCALES['zh-CN'] || {}, {
  ...
  'www.home.features.multiapi.desc': '每个渠道只配置一个目标协议；ccLoad 先尝试客户端线协议，并按 URL 缓存成功的回落结果',
  ...
  'www.home.features.protocol.desc': '先尝试客户端协议，再按 Anthropic、OpenAI、Codex、Gemini 回落，且不重复已试协议',
