...
window.I18N_LOCALES['zh-CN'] = Object.assign(window.I18N_LOCALES['zh-CN'] || {}, {
  ...
  'www.home.features.multiapi.desc': '每个渠道只配置一个目标协议；ccLoad 按固定顺序协商上游线协议，并按 URL 缓存成功结果',
  ...
  'www.home.features.protocol.desc': '按 Anthropic、OpenAI、Codex、Gemini 固定顺序协商，并按 URL 缓存成功协议',
