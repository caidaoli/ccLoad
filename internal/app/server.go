...
func (s *Server) SetupRoutes(r *gin.Engine) {
	...
	admin.Use(s.authService.RequireTokenAuth())
	{
		...
		admin.GET("/groups", s.HandleGroups)
		admin.POST("/groups", s.HandleGroups)
		admin.GET("/groups/model-options", s.HandleGroupModelOptions)
		admin.GET("/groups/:id", s.HandleGroupByID)
		admin.PUT("/groups/:id", s.HandleGroupByID)
		admin.DELETE("/groups/:id", s.HandleGroupByID)
