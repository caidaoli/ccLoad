...
func TestCSVExport_NoTimeFields(t *testing.T) {
	// 验证CSV导出不包含时间字段
	header := []string{"id", "name", "api_key", "url", "priority", "rpm_limit", "max_concurrency", "models", "model_redirects", "channel_type", "key_strategy", "enabled", "scheduled_check_enabled", "scheduled_check_model"}
