...
func (s *Server) HandleCreateAuthToken(c *gin.Context) {
	...
	if !model.IsValidChannelRestrictionMode(req.ChannelRestrictionMode) {
		RespondErrorMsg(c, http.StatusBadRequest, "channel_restriction_mode must be allow or deny")
		return
	}
	...
	authToken := &model.AuthToken{
		...
		ChannelRestrictionMode: model.NormalizeChannelRestrictionMode(req.ChannelRestrictionMode),
	}
...
func (s *Server) HandleUpdateAuthToken(c *gin.Context) {
	...
	if req.ChannelRestrictionMode != nil && !model.IsValidChannelRestrictionMode(*req.ChannelRestrictionMode) {
		RespondErrorMsg(c, http.StatusBadRequest, "channel_restriction_mode must be allow or deny")
		return
	}
	...
	if req.ChannelRestrictionMode != nil {
		token.ChannelRestrictionMode = model.NormalizeChannelRestrictionMode(*req.ChannelRestrictionMode)
	}
