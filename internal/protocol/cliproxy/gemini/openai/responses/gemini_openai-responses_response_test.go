...
func TestConvertGeminiResponseToOpenAIResponsesStream_LateGroundingMetadataAndCJKOffsets(t *testing.T) {
	...
	var param any
	events1 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk1, &param)
	events2 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk2, &param)
...
func TestConvertGeminiResponseToOpenAIResponsesStream_OutputIndexMatchesCompletedOrderWithLateGrounding(t *testing.T) {
	...
	var param any
	e1 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk1, &param)
	e2 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk2, &param)
	e3 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk3, &param)
	e4 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk4, &param)
	e5 := ConvertGeminiResponseToOpenAIResponses(context.Background(), modelID, req, []byte(`{"contents":[],"tools":[{"googleSearch":{}}]}`), chunk5, &param)
