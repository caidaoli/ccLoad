...
const (
	// KimiThinkingSignatureModeNonStreaming identifies signatures from non-streaming responses.
	KimiThinkingSignatureModeNonStreaming KimiThinkingSignatureMode = "non_streaming"
	// KimiThinkingSignatureModeStreaming identifies signatures from streaming responses.
