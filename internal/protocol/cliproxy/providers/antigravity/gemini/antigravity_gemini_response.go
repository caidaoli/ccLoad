...
func ConvertAntigravityResponseToGemini(_ context.Context, _ string, originalRequestRawJSON, requestRawJSON, rawJSON []byte, _ *any) [][]byte {
...
// GeminiTokenCount builds a Gemini countTokens response.
